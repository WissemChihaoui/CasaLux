  ...
  if (dt_user_table.length) {
    var dt_user = dt_user_table.DataTable({
      ...
      buttons: [
        ...
        {
          text: '<i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span class="d-none d-sm-inline-block">Ajouter un partenaire</span>',
...
$('.datatables-users').on('click', '.view-interlocutors', function() {
  ...
  $(document).on('click', '.delete-record', function () {
    ...
    $('#deleteModal .modal-body').text("Êtes-vous sûr de vouloir supprimer '" + title + "'?");
